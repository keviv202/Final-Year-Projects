...
public class Admin_Login extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Admin Login", 0, 0, new java.awt.Font("Cambria", 1, 12), new java.awt.Color(0, 102, 102))); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(tu, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE)
                                    .addComponent(tp))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String m="1";
            if(pass.equals(rs.getString(3))&& "Admin".equals(type))
            {
                ...
                else
                {
                    dispose();
                    String[] args = null;
                    Private_Form.value(user);
                    Private_Form.main(args);             
                }
            }   
            else
            {
                if(!"Admin".equals(type))
                jLabel4.setText("You do not have Admin Login");
            }
        } catch (SQLException ex) {
            jLabel4.setText("password or username Invalid");
